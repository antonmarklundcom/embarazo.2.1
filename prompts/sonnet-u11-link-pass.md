...
Read ONLY: this file, `docs/BUILD-QUEUE-2026-09-06.md` §4, §7, §10, every `docs/log/u*.md` that exists,
...
`docs/BUILD-QUEUE-2026-09-06.md` §10 · `KNOWN-ISSUES.md` · `e2e/home.spec.ts` (new or extended) · `docs/log/u11.md`.
...
5. `DECISIONS.md`: one entry "2026-09 build queue" summarising each unit's Decisions section from its log — pointers,
   ...
   fill §10 of the build queue. `KNOWN-ISSUES.md` (create it — it does not exist yet): promote only still-open, cross-unit items from the logs.
